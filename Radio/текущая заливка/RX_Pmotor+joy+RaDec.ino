...
//GStepper2<STEPPER2WIRE> stepper(7200, 5, 4, 3);                      // 200 драйвер steps, +pul, +dir, +enable
//GStepper2<STEPPER2WIRE> stepper(338400, 5, 4, 3);                      // 200 драйвер steps, +pul, +dir, +enable
...
EncButton button(2, INPUT_PULLUP);
