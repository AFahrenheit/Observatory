...
int8_t  hour = 23;       //часы       19             23              23
int8_t  minute = 15;    //мин.       12             15              15
int8_t date = 19;       //день       12             19              5
int8_t month = 8;      //месяц      10             8               6
int year = 2023;    //год       2023           2023            2022
int Ra = 69;        //п.в.    14h15m(855)    1h09m(69)     17h44m(1064)
int Dec = 2135;      //склон.  19gr03(1143)  35gr37(2137)    4gr33(273)
float Ra_h;
...
void Print() {
  ...
  Serial.print("Dec: "); Serial.println(Dec / 60.0);
